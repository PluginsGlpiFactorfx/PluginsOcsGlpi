...
JAVASCRIPT;
   ...
   static function getAvailableStatistics(){
      ...
      $stats = array('imported_machines_number'     => __('Entities imported', 'ocsinventoryng'),
                     'synchronized_machines_number' => __('Entities synchronized', 'ocsinventoryng'),
                     'linked_machines_number'       => __('Entities linked', 'ocsinventoryng'),
                     'notupdated_machines_number'   => __('Entities not updated', 'ocsinventoryng'),
                     'failed_rules_machines_number' => __("Entities don't check any rule",
                                                          'ocsinventoryng'),
                     'not_unique_machines_number'   => __('Duplicate Entities', 'ocsinventoryng'),
                     'link_refused_machines_number' => __('Entities whose import is refused by a rule',
                                                          'ocsinventoryng'));
      return $stats;
   }
